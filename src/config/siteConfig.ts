...
export const siteConfig: SiteConfig = {
  ...
  description:
    "KeQing 是一款基于 Astro 框架开发的清新美观且现代化个人博客主题，专为技术爱好者和内容创作者设计。该主题融合了现代 Web 技术栈，提供了丰富的功能模块和高度可定制的界面，让您能够轻松打造出专业且美观的个人博客网站。",
  keywords: [
    "KeQing",
    "Nth2Miss",
    "Astro",
  ...
  logoIcon: {
    type: "image",
    value: "/assets/images/emblem_128.png",
    alt: "🍀",
  },
  ...
  pages: {
    ...
    timeline: false, // 时间线页面开关，设为false时访问/timeline/会返回404
  ...
  backgroundWallpaper: {
    ...
    banner: {
      ...
      credit: {
        ...
        text: {
          desktop: "secretcanvas", // 桌面端要显示的来源文本
          mobile: "Mobile Credit", // 移动端要显示的来源文本
        },
        url: {
          desktop: "https://www.pixiv.net/artworks/133954465", // 桌面端原始艺术品或艺术家页面的 URL 链接
